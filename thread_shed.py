...
for item in daily_transactions_split:
  ...
  for data2 in item:
    ...
    transactions_clean2.append(data2.replace("\n", "").strip(" "))
  transactions_clean.append(transactions_clean2)
print(transactions_clean)
customers = []
sales = []
thread_sold = []
for data3 in transactions_clean:
  customers.append(data3[0])
  sales.append(data3[1])
  thread_sold.append(data3[2])
print(customers)
print(sales)
print(thread_sold)
total_sales = 0
...
for color in colors:
  print(f"{color_count(color)} Threads of {color} were sold today")
